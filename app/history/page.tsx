              ...
              >
                ...
                <div className="px-4 pb-3 flex justify-end border-t border-border/10 pt-2">
                  <button
                    ...
                    className="text-red-500 hover:text-red-700 text-sm font-medium flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {deletingId === conv.id ? (
                      <>
